    ...
    private static void Main(string[] args)
        {
            ...
            ColorMap.ColorPair testPair2 = new ColorMap.ColorPair() { majorColor = Color.Yellow, minorColor = Color.Green };
            pairNumber = ColorToNum.GetPairNumberFromColor(testPair2);
            Console.WriteLine("[In]Colors: {0}, [Out] PairNumber: {1}\n", testPair2, pairNumber);
            Debug.Assert(pairNumber == 18);

            testPair2 = new ColorMap.ColorPair() { majorColor = Color.Red, minorColor = Color.Blue };
            pairNumber = ColorToNum.GetPairNumberFromColor(testPair2);
